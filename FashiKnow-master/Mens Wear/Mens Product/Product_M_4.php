        ...
        <div class="row">
            <div class="col">
                ...
                <div class="slider">
                    <div class="product">
                        ...
                        <img src="images/5-1.jpg" alt="" onclick="clickme(this)">
                        <img src="images/5-2.jpg" alt="" onclick="clickme(this)">
                        <img src="images/5-3.jpg" alt="" onclick="clickme(this)">
                        <img src="images/5-4.jpg" alt="" onclick="clickme(this)">

                    </div>
                    <div class="preview">
                        <img src="images/5-1.jpg" id="imagebox" alt="">
                    </div>
                </div>
            ...
            <div class="col">
                ...
                <div class="content">
                    ...
                    <h2>DILLINGER</h2>
                   <div class="caption">
                     <p style="margin-left: 190px;">Sweatshirt</p>
                   </div>
                   <div class="cost">
                       <h3>₹700</h3> 
                        <p>MRP <strike>₹1999</strike> (65% OFF) </p>
                        <p></p>
                   </div>
                    <div class="rating">
                    ...
                    <p class="price">Brand: DILLINGER</p>
