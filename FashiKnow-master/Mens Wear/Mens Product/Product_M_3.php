...
<body>
    ...
    <div class="product_page" style="margin-top:-50px">
        <div class="row">
            <div class="col">
                ...
                <div class="slider">
                    <div class="product">
                        ...
                        <img src="images/4-1.jpg" alt="" onclick="clickme(this)">
                        <img src="images/4-2.jpg" alt="" onclick="clickme(this)">
                        <img src="images/4-3.jpg" alt="" onclick="clickme(this)">
                        <img src="images/4-4.jpg" alt="" onclick="clickme(this)">

                    </div>
                    <div class="preview">
                        <img src="images/4-1.jpg" id="imagebox" alt="">
                    </div>
                </div>
            ...
            <div class="col">
                ...
                <div class="content">
                   ...
                   <div class="cost">
                       <h3>₹1200</h3> 
                        <p>MRP <strike>₹2500</strike> (55% OFF) </p>
                        <p></p>
                   </div>
                    <div class="rating">
      ...
      <div class="related"><h2 style="font-family: lucidahandwriting; margin-left:560px; font-size: 30px; color: darkslateblue;">Similar Styles</h2>
            <div class="row">
                <div class="columns">
                    <div class="items">
