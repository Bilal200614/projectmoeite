...
<nav>
    ...
    <div class="navbar">
      ...
      <div class="logo"><a href="#">BARA</a></div>
      <div class="nav-links">
        <div class="sidebar-logo">
          <span class="logo-name">BARA</span>
          <i class='bx bx-x' ></i>
        </div>
        <ul class="links">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content clearfix">
                            ...
                            <div class="modal-body">
                                <p class="title">Welcome to BARA</p>
...
<div class="container" style="margin-top:150px;">
   <div class="products-container">
      <div class="product" data-name="p-1">
         ...
         <h3>Lightly Washed Zip-Front Jacket</h3>
      ...
      <div class="product" data-name="p-2">
         ...
         <h3>Floral Print Flared Kurta with Dapatta</h3>
         <p style="text-decoration: line-through; color: darkred;">
         ₹2,999
         </p>
      ...
      <div class="product" data-name="p-3">
         ...
         <h3>Fullsleeves Slim Fit Shirt</h3>
         <p style="text-decoration: line-through; color: darkred;">
         ₹1,999
         </p>
      ...
      <div class="product" data-name="p-4">
         ...
         <h3>Fastdry Active Crew-Neck T-Shirt</h3>
         <p style="text-decoration: line-through; color: darkred;">
         ₹2,999
         </p>
      ...
      <div class="product" data-name="p-6">
         ...
         <h3>Full Sleeves Slim Fit Shirt</h3>
         <p style="text-decoration: line-through; color: darkred;">
         ₹1,999
         </p>
      ...
      <div class="product" data-name="p-8">
         ...
         <h3>Straight Kurta with Band Collar</h3>
         <p style="text-decoration: line-through; color: darkred;">
         ₹2,999
         </p>
         <div class="price">₹1,999</div>
      ...
      <div class="product" data-name="p-11">
         ...
         <h3>Floral Print Black T-Shirt </h3>
         <p style="text-decoration: line-through; color: darkred;">
         ₹2,999
         </p>
         <div class="price">₹1,200</div>
...
<div class="products-preview">
   ...
   <div class="preview" data-target="p-1">
    <form action="cart.php" method="POST">
      ...
      <script type="text/javascript">
        ...
        <div class="buttons">
        <a href="Mens Product/Product_M_8.php"><span><p style="color:#ffffff">Quick View</p></span></a>   
      </div>
   </div>
   <div class="preview" data-target="p-2">
    <form action="cart.php" method="POST">
      ...
      <div class="buttons">
        <a href="Mens Product/Product_M_9.php"><span><p style="color:#ffffff">Quick View</p></span></a>
   ...
   <div class="preview" data-target="p-3">
    <form action="cart.php" method="POST">
     ...
     <div class="buttons">
        <a href="Mens Product/Product_M_2.php"><span><p style="color:#ffffff">Quick View</p></span></a>
   ...
   <div class="buttons">
        <a href="Mens Product/Product_M_4.php"><span><p style="color:#ffffff">Quick View</p></span></a>
   ...
   <div class="preview" data-target="p-6">
    <form action="cart.php" method="POST">
      ...
      <?php } ?>
       ...
       <div class="buttons">
        <a href="Mens Product/Product_M_1.php"><span><p style="color:#ffffff">Quick View</p></span></a>
      </div>
</div>
   <div class="preview" data-target="p-7">
    ...
    <div class="buttons">
        <a href="Mens Product/Product_M_7.php"><span><p style="color:#ffffff">Quick View</p></span></a>
    </div>
</div>
   ...
   <div class="buttons">
        <a href="Mens Product/Product_M_5.php"><span><p style="color:#ffffff">Quick View</p></span></a>
      </div>
</div>
 ...
 <div class="preview" data-target="p-10">
    ...
    <div class="buttons">
        <a href="Mens Product/Product_M_10.php"><span><p style="color:#ffffff">Quick View</p></span></a>
      </div>
</div>
