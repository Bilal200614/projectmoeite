      ...
      <div class="nav-links">
        ...
        <ul class="links">
          ...
          <li>
            ...
            <ul class="htmlCss-sub-menu sub-menu" id="profile">
...
<!-- Image Carousel -->
<div class="image_carousel" id="fashion" style="margin-top: -20px" data-aos="fade-up" data-aos-duration="3000">
        <div class="gallery">
...
<div class="component3" style="margin-top:15px" data-aos="fade-up" data-aos-duration="3000">
    <div class="container">
...
<!-- Photo Grid -->
<div class="row-new" style="margin-top:-50px"> 
