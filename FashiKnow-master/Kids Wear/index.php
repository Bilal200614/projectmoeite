...
<nav>
    ...
    <div class="navbar">
      ...
      <div class="nav-links">
        ...
        <ul class="links">
          <li><a href="http://localhost/DevStarters/webathon/home.php" class="home">Home</a></li>
          <li>
            <a href="#">Shop</a>
            <i class='bx bxs-chevron-down htmlcss-arrow arrow  '></i>

            <ul class="htmlCss-sub-menu sub-menu">
              <li><a href="http://localhost/DevStarters/webathon/Mens%20Wear/">Mens Wear</a></li>
              <li><a href="http://localhost/DevStarters/webathon/Womens%20Wear/">Womens Wear</a></li>
              <li><a href="http://localhost/DevStarters/webathon/Kids%20Wear/">Kids Wear</a></li>
...
<div class="preview" data-target="p-2">
   ...
   <div class="preview" data-target="p-7">
    <form action="cart.php" method="POST">
     ...
     <div class="buttons">
        <a href="Kids Product/Product_K_9.php"><span><p style="color:#ffffff">Quick View</p></span></a>   </div>
</div>
