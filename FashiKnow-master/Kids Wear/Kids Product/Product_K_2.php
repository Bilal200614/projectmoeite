            ...
            <div class="col">
                ...
                <div class="slider">
                    ...
                    <div class="product">
                        ...
                        <img src="images/k-2-2.jpg" alt="" onclick="clickme(this)">
                        <img src="images/k-2-1.jpg" alt="" onclick="clickme(this)">
                        <img src="images/k-2-3.jpg" alt="" onclick="clickme(this)">
                        <img src="images/k-2-4.jpg" alt="" onclick="clickme(this)">

                    </div>
                    <div class="preview">
                        <img src="images/k-2-1.jpg" id="imagebox" alt="">
                    </div>
                </div>
...
<!-- 
           ...
           <div class="Pro_details" style="margin-top:10px; margin-bottom: 10px;">
               <ul>
                   <li>Package contains: 2 t-shirt</li>
