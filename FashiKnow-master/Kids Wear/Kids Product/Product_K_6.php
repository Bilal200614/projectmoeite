        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="slider">
                    ...
                    <div class="product">
                        ...
                        <img src="images/k-6-1.png" alt="" onclick="clickme(this)">
                        <img src="images/k-6-2.png" alt="" onclick="clickme(this)">
                        <img src="images/k-6-3.png" alt="" onclick="clickme(this)">
                        <img src="images/k-6-4.png" alt="" onclick="clickme(this)">

                    </div>
                    <div class="preview">
                        <img src="images/k-6-1.png" id="imagebox" alt="">
                    </div>
                </div>
            ...
            <div class="col">
               ...
               <div class="content">
                   ...
                   <div class="caption">
                     <p>Polo T-shirt with Chest Logo Print</p>
                   </div>
                   <div class="cost">
                       <h3>₹1250</h3> 
...
<!-- 
        ...
        <div class="related">
            ...
            <div class="row">
                <div class="columns">
                    <div class="items">
                          <a href="Product_M_1"><img src="images/k-2-1.jpg" alt=""> </a>
                        <div class="details">
                ...
                <div class="columns">
                    <div class="items">
                          <a href="Product_M_3"><img src="images/k-4-1.png" alt=""> </a>
                        <div class="details">
                            <p>Polo T-shirt with Logo Print</p>
                            <div class="rating">
                                <i class="fa fa-star"></i>
                ...
                <div class="columns">
                    <div class="items">
                           <a href="Product_M_4"><img src="images/k-5-1.png" alt=""> </a>
                        <div class="details">
                            <p>Polo T-shirt with Logo Print</p>
                            <div class="rating">
                                <i class="fa fa-star"></i>
